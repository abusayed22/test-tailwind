...
function App() {
  ...
  return (<p className="text-amber-500 text-center mt-10 hover:text-red-500/50">
    hello this is <b>just in time</b> (jit) compilid expriment/testing
  </p>
    // <div className="App">
    ...
    //         <h1 className="myWish hover:myWishs font-black-700 font-bold space-y-2">Tailwind CSS code test</h1>
    //         <p className="text-gray-500 dark:text-yellow-700 bg-red-500 space-y-2 font-medium">For practiceing</p>
